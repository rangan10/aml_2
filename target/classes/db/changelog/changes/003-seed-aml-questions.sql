...
('AML003_SUM_INSURED_REASON',
 ...
 'TEXT', 'GLOBAL', 'QUOTATION', TRUE, NOW(), NOW(), 24, 1.0),
...
('AML003_ADDRESS_MISMATCH_REASON',
 ...
 'TEXT', 'GLOBAL', 'KYC', TRUE, NOW(), NOW(), 1, 1.0),
...
('AML008_ADDRESS_CHANGE_REASON',
 ...
 'TEXT', 'GLOBAL', 'KYC', TRUE, NOW(), NOW(), 2, 1.0),
...
('AML010_DUPLICATE_IDENTITY',
 ...
 'BOOLEAN', 'GLOBAL', 'KYC', TRUE, NOW(), NOW(), 3, 1.0),
...
('AML011_ADVERSE_MEDIA_DECLARATION',
 ...
 'BOOLEAN', 'GLOBAL', 'KYC', TRUE, NOW(), NOW(), 4, 1.0),
...
('AML015_ASSET_HYPOTHECATION',
 ...
 'BOOLEAN', 'GLOBAL', 'POLICY', TRUE, NOW(), NOW(), 34, 1.0),
...
('AML018_THIRD_PARTY_PAYER_REASON',
 ...
 'TEXT', 'GLOBAL', 'PAYMENT', TRUE, NOW(), NOW(), 50, 1.0),

('AML_PEP_SELF_DECLARATION',
 'Are you a Politically Exposed Person (PEP)?',
 'BOOLEAN', 'GLOBAL', 'PROFILE', TRUE, NOW(), NOW(), 10, 1.0),

('AML_PEP_FAMILY_DECLARATION',
 'Is any of your immediate family members a Politically Exposed Person (PEP)?',
 'BOOLEAN', 'GLOBAL', 'PROFILE', TRUE, NOW(), NOW(), 11, 1.0),

('AML_NRI_DECLARATION',
 'Are you a Non-Resident Indian (NRI)?',
 'BOOLEAN', 'GLOBAL', 'PROFILE', TRUE, NOW(), NOW(), 12, 1.0),

('CKYC_KIN_NUMBER',
 'What is your CKYC KIN number?',
 'TEXT', 'TENANT_SPECIFIC', 'DOCUMENT', TRUE, NOW(), NOW(), 7, 1.0),

('BENEFICIAL_OWNER_FLAG',
 'Is there a beneficial owner other than the insured/proposer?',
 'BOOLEAN', 'TENANT_SPECIFIC', 'NOMINEE', TRUE, NOW(), NOW(), 39, 1.0),

('NRI_FLAG',
 'Are you a Non-Resident Indian (NRI)?',
 'BOOLEAN', 'TENANT_SPECIFIC', 'PROFILE', TRUE, NOW(), NOW(), 13, 1.0),

('NOMINEE_RELATIONSHIP',
 'What is the nominee''s relationship to the insured?',
 'TEXT', 'TENANT_SPECIFIC', 'NOMINEE', TRUE, NOW(), NOW(), 40, 1.0),

('PAYER_NAME',
 'What is the payer''s name?',
 'TEXT', 'TENANT_SPECIFIC', 'PAYMENT', TRUE, NOW(), NOW(), 45, 1.0),

('PAN_NUMBER',
 'What is your PAN number?',
 'TEXT', 'TENANT_SPECIFIC', 'DOCUMENT', TRUE, NOW(), NOW(), 8, 1.0),

('RELATED_TO_PEP',
 'Are you related to a Politically Exposed Person (PEP)?',
 'BOOLEAN', 'TENANT_SPECIFIC', 'PROFILE', TRUE, NOW(), NOW(), 14, 1.0),

('SOURCE_OF_INCOME',
 'What is your primary source of income?',
 'SINGLE_CHOICE', 'TENANT_SPECIFIC', 'PROFILE', TRUE, NOW(), NOW(), 15, 1.0),

('PAYMENT_MODE',
 'What is the mode of premium payment?',
 'SINGLE_CHOICE', 'TENANT_SPECIFIC', 'PAYMENT', TRUE, NOW(), NOW(), 46, 1.0),

('PREMIUM_PAYER_TYPE',
 'Who is paying the premium for this policy?',
 'SINGLE_CHOICE', 'TENANT_SPECIFIC', 'PAYMENT', TRUE, NOW(), NOW(), 51, 1.0),

('PAYER_PAN',
 'What is the payer''s PAN number?',
 'TEXT', 'TENANT_SPECIFIC', 'PAYMENT', TRUE, NOW(), NOW(), 52, 1.0),

('RELATIONSHIP_TO_INSURED',
 'What is the payer''s relationship to the insured?',
 'TEXT', 'TENANT_SPECIFIC', 'PAYMENT', TRUE, NOW(), NOW(), 53, 1.0),

('ULTIMATE_BENEFICIAL_OWNER_NAME',
 'What is the name of the Ultimate Beneficial Owner (UBO)?',
 'TEXT', 'TENANT_SPECIFIC', 'NOMINEE', TRUE, NOW(), NOW(), 41, 1.0),

('ASSIGNEE_EXISTS',
 'Does this policy have an assignee?',
 'BOOLEAN', 'TENANT_SPECIFIC', 'NOMINEE', TRUE, NOW(), NOW(), 42, 1.0),

('EMAIL_ADDRESS',
 'What is your email address?',
 'TEXT', 'TENANT_SPECIFIC', 'PROFILE', TRUE, NOW(), NOW(), 16, 1.0),

('FOREIGN_COUNTRY',
 'Which foreign country is the source of funds from?',
 'TEXT', 'TENANT_SPECIFIC', 'PROFILE', TRUE, NOW(), NOW(), 17, 1.0),

('NGO_TRUST_AFFILIATION',
 'Do you have any NGO or Trust affiliation?',
 'BOOLEAN', 'TENANT_SPECIFIC', 'PROFILE', TRUE, NOW(), NOW(), 18, 1.0),

('COUNTRY_OF_RESIDENCE',
 'What is your country of residence?',
 'TEXT', 'TENANT_SPECIFIC', 'PROFILE', TRUE, NOW(), NOW(), 19, 1.0),

('CURRENT_ADDRESS',
 'What is your current address?',
 'TEXT', 'TENANT_SPECIFIC', 'PROFILE', TRUE, NOW(), NOW(), 20, 1.0),

('MOBILE_NUMBER',
 'What is your mobile number?',
 'TEXT', 'TENANT_SPECIFIC', 'PROFILE', TRUE, NOW(), NOW(), 21, 1.0),

('PERMANENT_ADDRESS',
 'What is your permanent address?',
 'TEXT', 'TENANT_SPECIFIC', 'PROFILE', TRUE, NOW(), NOW(), 22, 1.0),

('ANNUAL_INCOME',
 'What is your annual income?',
 'NUMBER', 'TENANT_SPECIFIC', 'PROFILE', TRUE, NOW(), NOW(), 23, 1.0);