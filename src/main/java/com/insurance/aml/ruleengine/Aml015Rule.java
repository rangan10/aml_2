...
public class Aml015Rule implements AmlRule {

    private static final String RULE_CODE = "AML015";
    ...
    public RuleEvaluationResult evaluate(RuleContext context) {
        ...
        var threshold = properties.getAml015().getClaimThreshold();
        ...
        return RuleEvaluationResult.builder()
                ...
                .description("AML015 triggered: first-year claim >= " + threshold
